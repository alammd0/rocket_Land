...
const About = () => {
	return (
		<div>
			{/* Section : 01 */}
			<section className="w-11/14 mx-auto pt-[100px] pb-[60px]">
				<div className="flex flex-col gap-12">
					<div className="flex flex-col gap-1 items-center justify-center">
						<p className="text-2xl font-bold text-[#30343B]">
							About Sprocket Rocket
						</p>
						<h2 className="text-5xl font-bold w-[50%] text-center text-[#30343B]">
					...
					<div className="flex flex-col gap-4 items-center justify-center">
						<img
							...
							alt="Not Image"
						/>
						<p className="w-[52%] text-center text-[18px] font-semibold text-[#87909E]">
			...
			<section className="bg-[#060F1E] pt-[60px] pb-[60px] mt-[30px] mb-[30px]">
				<div className="w-11/14 mx-auto flex flex-row items-center justify-between">
			...
			{/* Section : 03 */}
			<section className="w-11/14 mx-auto pt-[60px] pb-[60px]">
				<div className="flex flex-col gap-5 items-start justify-center w-[47%] mx-auto">
			...
			<section>
				<div
					...
					<h2 className="text-6xl flex items-start text-left font-bold text-white">
						Never feel stuck again.
					</h2>
					<p className="text-[24px] text-white w-[40%] text-center">
